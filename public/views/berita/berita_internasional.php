<?php
include '../../header.php';
$query = "SELECT * FROM tb_berita WHERE publish = 'yes' AND status = 'INTERNASIONAL' ORDER BY id_berita DESC"; // Sesuaikan dengan struktur tabel Anda
